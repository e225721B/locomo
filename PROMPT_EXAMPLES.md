...
| 項目               | パターン A (関係値内省あり)          | パターン B (想起あり)            |
| ------------------ | ------------------------------------ | -------------------------------- |
| **過去の会話参照** | なし（セッション間のサマリーのみ）   | 具体的な発話を想起               |
| **態度調整**       | Intimacy/Power 数値で明示的に指示    | 想起内容から暗黙的に判断         |
| **プロンプト長**   | 短め                                 | 想起件数に応じて増加             |
| **用途**           | 関係性の変化を明示的に制御したい場合 | 過去の文脈を詳細に活用したい場合 |
